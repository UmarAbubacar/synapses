...
# load state
LoadState("output/synapses/synapses.pvsm")
...
renderView1.ResetCamera(
    -4.98292255402, 4.98292255402, -4.98292255402, 4.98292255402, -5.0, 5.0
)
...
if params.screenshots:
    SaveScreenshot(
        "output/pyramidal-cell-single.png",
        renderView1,
        ImageResolution=[1200, 4000],
